        ...
        <div className="container mx-auto p-4 flex flex-col-reverse md:flex-row items-center">
          <div className="md:w-10/12 p-4">
            ...
            <p className="py-4 text-black">
              ...
              <br />
              <br />
              Descubre nuestra exclusiva colección de ropa con diseños
              inspirados en el código fuente, accesorios que incorporan
              elementos tecnológicos de vanguardia y joyería que refleja tu amor
              por la era digital.
              <br />
              <br />
              ...
              ¡Explora nuestra tienda y déjate llevar por la revolución de la
              moda tecnológica!
            </p>
